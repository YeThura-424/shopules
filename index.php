        ...
        ?>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 ">
                <div class="card categoryCard border-0 shadow-sm p-3 mb-5 rounded text-center">
                    <img src="<?= $cphoto ?>" class="card-img-top" style="height:170px; object-fit: cover;">
                    <div class="card-body">
        ...
        <div class="col-12">
            <div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel" data-interval="1000">
                <div class="MultiCarousel-inner">
                    <?php
                    $sql = "SELECT * FROM items  WHERE discount > 0 ORDER BY rand() LIMIT 10";
                    $stmt = $conn->prepare($sql);
                    $stmt->execute();
                    $items = $stmt->fetchAll();
                    ...
                    ?>
                        <div class="item">
                            <div class="pad15">
                                <a href="frontenditemdetail.php?id=<?= $iid ?>">
                                    <img src="<?= $iphoto ?>" class="img-fluid" style="height:170px; object-fit: cover;">
                                </a>
                                <p class="text-truncate"><?= "YT_" . $icodeno ?></p>
                                <p class="item-price">
                                    <?php if ($idiscount) : ?>
                                ...
                                <button class="addtocartBtn text-decoration-none" data-id="<?= $iid ?>" data-name="<?= $iname ?>" data-codeno="<?= $icodeno ?>" data-photo="<?= $iphoto ?>" data-price="<?= $iprice ?>" data-discount="<?= $idiscount ?>">Add to Cart</button>

                            </div>
                        </div>
                    <?php } ?>
                </div>
                <button class="btn btnMain leftLst">
                    << /button> <button class="btn btnMain rightLst">>
                        </button>
            </div>
        </div>
    </div>
